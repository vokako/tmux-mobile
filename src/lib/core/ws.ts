...
export const skillsImport = (source: string) => call<{ ok: boolean; imported: string[]; skipped: string[] }>('skills_import', { source });
export const skillsFiles = (name: string) => call<{ name: string; files: { path: string; size: number }[] }>('skills_files', { name });
export const skillsFile = (name: string, path: string) => call<{ name: string; path: string; content: string }>('skills_file', { name, path });
