...
<style>
  ...
  :global(html[data-theme="dark"]) {
    ...
    --status-ok: #4ade80; --status-warn: #fbbf24; --status-danger: #ff5050; --status-hot: #fb923c; --status-sleep: #818cf8;
  ...
  :global(html[data-theme="light"]) {
    ...
    --status-ok: #16a34a; --status-warn: #ca8a04; --status-danger: #e53e3e; --status-hot: #ea580c; --status-sleep: #6366f1;
