...
- Window chips show unread agent attention dots without changing chip height; opening that window marks its server-persisted notification read across connected clients.
